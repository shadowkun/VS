...
typedef ::shadow::static_assert_test<									\
sizeof(::shadow::STATIC_ASSERTION_FAILURE< (bool)( B ) >)>			\
WBL_JOIN(shadow_static_assert_typedef_, __COUNTER__)
#else							// for others
#	define WBL_STATIC_ASSERT( B )											\
typedef ::shadow::static_assert_test<									\
sizeof(::shadow::STATIC_ASSERTION_FAILURE< (bool)( B ) >)>			\
WBL_JOIN(shadow_static_assert_typedef_, __LINE__)
#endif
